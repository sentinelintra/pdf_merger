 ...
 * 
 */
@WebServiceClient(name = "ReportService", targetNamespace = "http://xmlns.oracle.com/oxp/service/v2", wsdlLocation = "http://prodobiee:9704/xmlpserver/services/v2/ReportService?wsdl")
public class ReportService_Service
    extends Service
{

    private final static URL REPORTSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(ru.sentinelcredit.bi.ReportService_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = ru.sentinelcredit.bi.ReportService_Service.class.getResource(".");
            url = new URL(baseUrl, "http://prodobiee:9704/xmlpserver/services/v2/ReportService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://prodobiee:9704/xmlpserver/services/v2/ReportService?wsdl', retrying as a local file");
